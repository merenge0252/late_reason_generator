...
${!isHumorousTone ? '2.  **物的証拠がなくても、状況の説明で十分に納得させられる理由を優先して生成してください。**' : ''}
...
`;
    ...
    if (situation) {
      ...
      prompt += `「具体的な状況」が提供されていない場合は、現実的で、かつ説得力があり、**${!isHumorousTone ? '物的証拠を必要とせず口頭で説明がしやすい' : '面白さやユニークさを追求した'}**具体的な出来事を想像して言い訳を生成してください。\n`;
    }
